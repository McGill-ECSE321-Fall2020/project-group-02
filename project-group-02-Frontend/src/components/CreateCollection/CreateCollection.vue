  ...
  <div class="container">
    ...
    <form class="" action="/compose" method="post">
      <div class="form-group">
        ...
        <input v-model="c_name" id="cNameInput" class="txtbox form-control" type="text" name="C_name">
        <p>{{c_name}} </p>

        <label>Collection Description</label>
        <textarea v-model="c_description" class="txtbox form-control" name="postContent" rows="8"></textarea>
        <p>{{c_description}} </p>

        <div class= "">
        <label for="exampleInputFile">Upload Collection image</label>
      ...
      <router-link to='/collections'>
        <button @click="uploadCollection" class=" btn btn-dark" type="submit" name="button">Publish</button>
      </router-link>
